...
- Usage: Reference from command with `@/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
