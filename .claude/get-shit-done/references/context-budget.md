...
The keys live in `.claude/settings.json` (project) or `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/settings.json` (global) — **not** in `.planning/config.json`:
