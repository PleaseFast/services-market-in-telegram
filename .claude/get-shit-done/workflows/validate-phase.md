...
```
Agent(
  prompt="Read /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/get-shit-done/templates/VALIDATION.md`
