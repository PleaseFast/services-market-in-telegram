...
<required_reading>
@/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/get-shit-done/references/ai-frameworks.md
@/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/agents/gsd-eval-planner.md for instructions.
