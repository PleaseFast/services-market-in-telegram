...
- **Global scope**: `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/notes/`)
...
2. Glob `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/andreimitugov/Andrew/doings/services-market-in-telegram/.claude/notes/` — works in any directory
